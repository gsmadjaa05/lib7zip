...
void C7ZipDllHandler::Initialize()
{
    ...
    pFunctions->v.GetMethodProperty =
        reinterpret_cast<GetMethodPropertyFunc>(reinterpret_cast<void*>(GetProcAddress((HMODULE)m_pHandler, myT("GetMethodProperty"))));
    pFunctions->v.GetNumberOfMethods =
        reinterpret_cast<GetNumberOfMethodsFunc>(reinterpret_cast<void*>(GetProcAddress((HMODULE)m_pHandler, myT("GetNumberOfMethods"))));
    pFunctions->v.GetNumberOfFormats =
        reinterpret_cast<GetNumberOfFormatsFunc>(reinterpret_cast<void*>(GetProcAddress((HMODULE)m_pHandler, myT("GetNumberOfFormats"))));
    pFunctions->v.GetHandlerProperty =
        reinterpret_cast<GetHandlerPropertyFunc>(reinterpret_cast<void*>(GetProcAddress((HMODULE)m_pHandler, myT("GetHandlerProperty"))));
    pFunctions->v.GetHandlerProperty2 =
        reinterpret_cast<GetHandlerPropertyFunc2>(reinterpret_cast<void*>(GetProcAddress((HMODULE)m_pHandler, myT("GetHandlerProperty2"))));
    pFunctions->v.CreateObject =
        reinterpret_cast<CreateObjectFunc>(reinterpret_cast<void*>(GetProcAddress((HMODULE)m_pHandler, myT("CreateObject"))));
    pFunctions->v.SetLargePageMode =
        reinterpret_cast<SetLargePageModeFunc>(reinterpret_cast<void*>(GetProcAddress((HMODULE)m_pHandler, myT("SetLargePageMode"))));
